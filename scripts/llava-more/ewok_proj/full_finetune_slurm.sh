...
images_path= #  root folder of where COCO train2017 images reside (after zip extraction)
data_train_path= #  path to llava_instruct_80k.json
vision_tower=openai/clip-vit-large-patch14-336
mm_projector_path= #  path to mm_projector.bin file
