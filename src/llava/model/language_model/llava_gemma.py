...
from transformers import AutoConfig, AutoModelForCausalLM, Gemma2Model, Gemma2Config, Gemma2ForCausalLM #Gemma3TextModel, Gemma3TextConfig, Gemma3ForCausalLM
...
class LlavaGemmaForCausalLM(Gemma2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        # control if logits_to_keep is accepted by the model
